...
curve(plogis(alpha.theta + beta1.theta * x), -2, 2, col = "red", add = TRUE, lwd = 3)
plot(site.cov[,2], s, ylim = c(0,1), main = "'Suitability' & site covariate 2")
curve(plogis(alpha.theta + beta2.theta * x), -2, 2, col = "red", add = TRUE, lwd = 3)
plot(site.cov[,3], s, ylim = c(0,1), main = "'Suitability' & site covariate 3")
curve(plogis(alpha.theta + beta3.theta * x), -2, 2, col = "red", add = TRUE, lwd = 3)
...
curve(plogis(qlogis(mean.p) + beta3.p * x), -2, 2, xlab = "Site covariate 3", main = "Site covariate 3 & detection", ylab = "p", col = "red", lwd = 3)
curve(plogis(qlogis(mean.p) + beta5.p * x), -2, 2, xlab = "Site covariate 5", main = "Site covariate 5 & detection", ylab = "p", col = "red", lwd = 3)
curve(plogis(qlogis(mean.p) + beta6.p * x), -2, 2, xlab = "Site covariate 6", main = "Site covariate 6 & detection", ylab = "p", col = "red", lwd = 3)
curve(plogis(qlogis(mean.p) + beta.p.survey * x), -2, 2, xlab = "Survey covariate", main = "Survey covariate & detection", ylab = "p", col = "red", lwd = 3)
curve(plogis(qlogis(mean.p) + beta.p.N * x), log(0+1), log(max(N)+1), xlab = "Effect of log(N+1) in logit(p)", ylab = "p", col = "red", lwd = 3)
