...
system("R CMD INSTALL --build AHMbook_0.1.4.9107.tar.gz") # installs and produces the .zip binary
system("R CMD INSTALL --build --with-keep.source AHMbook_0.1.4.9107.tar.gz") # installs and produces the .zip binary
